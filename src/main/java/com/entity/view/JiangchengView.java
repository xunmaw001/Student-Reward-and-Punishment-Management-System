...
public class JiangchengView extends JiangchengEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 奖惩级别的值
		*/
		private String jiangchengJibieValue;
	...
	public JiangchengView(JiangchengEntity jiangchengEntity) {
		try {
			...
			* 获取： 奖惩级别的值
			*/
			public String getJiangchengJibieValue() {
				return jiangchengJibieValue;
			}
			/**
			* 设置： 奖惩级别的值
			*/
			public void setJiangchengJibieValue(String jiangchengJibieValue) {
				this.jiangchengJibieValue = jiangchengJibieValue;
			}
