 ...
 */
@TableName("chuqinlv")
public class ChuqinlvView extends ChuqinlvEntity implements Serializable {
	...
	public ChuqinlvView(ChuqinlvEntity chuqinlvEntity) {
		try {
			BeanUtils.copyProperties(this, chuqinlvEntity);
