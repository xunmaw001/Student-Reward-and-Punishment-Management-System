    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="成绩编号" prop="chengjiUuidNumber">
                       <el-input v-model="ruleForm.chengjiUuidNumber"
                                 placeholder="成绩编号" clearable  :readonly="ro.chengjiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="成绩编号" prop="chengjiUuidNumber">
                           <el-input v-model="ruleForm.chengjiUuidNumber"
                                     placeholder="成绩编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="成绩名称" prop="chengjiName">
                       <el-input v-model="ruleForm.chengjiName"
                                 placeholder="成绩名称" clearable  :readonly="ro.chengjiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="成绩名称" prop="chengjiName">
                           <el-input v-model="ruleForm.chengjiName"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="成绩详情" prop="chengjiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chengjiContent" label="成绩详情" prop="chengjiContent">
                            <span v-html="ruleForm.chengjiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="成绩分数" prop="chengjiFenshu">
                       <el-input v-model="ruleForm.chengjiFenshu"
                                 placeholder="成绩分数" clearable  :readonly="ro.chengjiFenshu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="成绩分数" prop="chengjiFenshu">
                           <el-input v-model="ruleForm.chengjiFenshu"
                                     placeholder="成绩分数" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="所得分数" prop="chengjiDedaoFenshu">
                       <el-input v-model="ruleForm.chengjiDedaoFenshu"
                                 placeholder="所得分数" clearable  :readonly="ro.chengjiDedaoFenshu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="所得分数" prop="chengjiDedaoFenshu">
                           <el-input v-model="ruleForm.chengjiDedaoFenshu"
                                     placeholder="所得分数" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    xueshengId: false,
                    chengjiUuidNumber: false,
                    chengjiName: false,
                    chengjiTypes: false,
                    chengjiContent: false,
                    chengjiFenshu: false,
                    chengjiDedaoFenshu: false,
                    insertTime: false,
                },
                ruleForm: {
                    xueshengId: '',
                ...
                rules: {
                   ...
                   chengjiFenshu: [
                              { required: true, message: '成绩分数不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   chengjiDedaoFenshu: [
                              { required: true, message: '所得分数不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
