    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="奖惩编号" prop="jiangchengUuidNumber">
                       <el-input v-model="ruleForm.jiangchengUuidNumber"
                                 placeholder="奖惩编号" clearable  :readonly="ro.jiangchengUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="奖惩编号" prop="jiangchengUuidNumber">
                           <el-input v-model="ruleForm.jiangchengUuidNumber"
                                     placeholder="奖惩编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="奖惩级别" prop="jiangchengJibieTypes">
                        <el-select v-model="ruleForm.jiangchengJibieTypes" :disabled="ro.jiangchengJibieTypes" placeholder="请选择奖惩级别">
                            <el-option
                                v-for="(item,index) in jiangchengJibieTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="奖惩级别" prop="jiangchengJibieValue">
                        <el-input v-model="ruleForm.jiangchengJibieValue"
                            placeholder="奖惩级别" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="奖惩分数" prop="jiangchengFenshu">
                       <el-input v-model="ruleForm.jiangchengFenshu"
                                 placeholder="奖惩分数" clearable  :readonly="ro.jiangchengFenshu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="奖惩分数" prop="jiangchengFenshu">
                           <el-input v-model="ruleForm.jiangchengFenshu"
                                     placeholder="奖惩分数" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    xueshengId: false,
                    jiangchengUuidNumber: false,
                    jiangchengName: false,
                    jiangchengTypes: false,
                    jiangchengErjiTypes: false,
                    jiangchengJibieTypes: false,
                    jiangchengFenshu: false,
                    jiangchengContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    xueshengId: '',
                    jiangchengUuidNumber: new Date().getTime(),
                    jiangchengName: '',
                    jiangchengTypes: '',
                    jiangchengErjiTypes: '',
                    jiangchengJibieTypes: '',
                    jiangchengFenshu: '',
                    jiangchengContent: '',
                    insertTime: '',
                },
                ...
                rules: {
                   ...
                   jiangchengUuidNumber: [
                              { required: true, message: '奖惩编号不能为空', trigger: 'blur' },
                          ],
                   jiangchengName: [
                   ...
                   jiangchengJibieTypes: [
                              { required: true, message: '奖惩级别不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiangcheng_jibie_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jiangchengJibieTypesOptions = data.data.list;
                    }
                });
