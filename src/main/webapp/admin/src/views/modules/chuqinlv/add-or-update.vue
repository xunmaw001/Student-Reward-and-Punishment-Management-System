    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='xuesheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="分数" prop="xueshengFenshu">
                        <el-input v-model="xueshengForm.xueshengFenshu"
                                  placeholder="分数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="分数" prop="xueshengFenshu">
                            <el-input v-model="ruleForm.xueshengFenshu"
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="出勤率编号" prop="chuqinlvUuidNumber">
                       <el-input v-model="ruleForm.chuqinlvUuidNumber"
                                 placeholder="出勤率编号" clearable  :readonly="ro.chuqinlvUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="出勤率编号" prop="chuqinlvUuidNumber">
                           <el-input v-model="ruleForm.chuqinlvUuidNumber"
                                     placeholder="出勤率编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="月份" prop="chuqinlvYue">

                       <el-date-picker
                               v-model="ruleForm.chuqinlvYue"
                               type="month"
                   ...
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="月份" prop="chuqinlvYue">
                           <el-input v-model="ruleForm.chuqinlvYue"
                                     placeholder="月份" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="出勤率" prop="chuqinlvName">
                       <el-input v-model="ruleForm.chuqinlvName"
                                 placeholder="出勤率" clearable  :readonly="ro.chuqinlvName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="出勤率" prop="chuqinlvName">
                           <el-input v-model="ruleForm.chuqinlvName"
                                     placeholder="出勤率" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="出勤率分数" prop="chuqinlvFenshu">
                       <el-input v-model="ruleForm.chuqinlvFenshu"
                                 placeholder="出勤率分数" clearable  :readonly="ro.chuqinlvFenshu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="出勤率分数" prop="chuqinlvFenshu">
                           <el-input v-model="ruleForm.chuqinlvFenshu"
                                     placeholder="出勤率分数" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="出勤率详情" prop="chuqinlvContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.chuqinlvContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chuqinlvContent" label="出勤率详情" prop="chuqinlvContent">
                            <span v-html="ruleForm.chuqinlvContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    xueshengId: false,
                    chuqinlvUuidNumber: false,
                    chuqinlvYue: false,
                    chuqinlvName: false,
                    chuqinlvFenshu: false,
                    chuqinlvContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    xueshengId: '',
                    chuqinlvUuidNumber: new Date().getTime(),
                    chuqinlvYue: '',
                    chuqinlvName: '',
                    chuqinlvFenshu: '',
                    chuqinlvContent: '',
                ...
                rules: {
                   ...
                   chuqinlvUuidNumber: [
                              { required: true, message: '出勤率编号不能为空', trigger: 'blur' },
                          ],
                   chuqinlvYue: [
                   ...
                   chuqinlvFenshu: [
                              { required: true, message: '出勤率分数不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   chuqinlvContent: [
                              { required: true, message: '出勤率详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`chuqinlv/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chuqinlvCrossAddOrUpdateFlag = false;
                                        this.parent.search();
