    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="记录类型" prop="fenshujiluTypes">
                        <el-select v-model="ruleForm.fenshujiluTypes" :disabled="ro.fenshujiluTypes" placeholder="请选择记录类型">
                            <el-option
                                v-for="(item,index) in fenshujiluTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="记录类型" prop="fenshujiluValue">
                        <el-input v-model="ruleForm.fenshujiluValue"
                            placeholder="记录类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="记录分数" prop="fenshujiluFenshu">
                       <el-input v-model="ruleForm.fenshujiluFenshu"
                                 placeholder="记录分数" clearable  :readonly="ro.fenshujiluFenshu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="记录分数" prop="fenshujiluFenshu">
                           <el-input v-model="ruleForm.fenshujiluFenshu"
                                     placeholder="记录分数" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="记录详情" prop="fenshujiluContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.fenshujiluContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.fenshujiluContent" label="记录详情" prop="fenshujiluContent">
                            <span v-html="ruleForm.fenshujiluContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    xueshengId: false,
                    fenshujiluTypes: false,
                    fenshujiluFenshu: false,
                    fenshujiluContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    xueshengId: '',
                ...
                rules: {
                   ...
                   fenshujiluFenshu: [
                              { required: true, message: '记录分数不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=fenshujilu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.fenshujiluTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`fenshujilu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.fenshujiluCrossAddOrUpdateFlag = false;
                                        this.parent.search();
