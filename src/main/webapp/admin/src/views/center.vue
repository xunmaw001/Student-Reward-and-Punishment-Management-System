  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='xuesheng'"  label='分数' prop="xueshengFenshu">
               <el-input v-model="ruleForm.xueshengFenshu"  placeholder='分数' clearable></el-input>
           </el-form-item>
         </el-col>
...
// 注册表 学生 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.xueshengFenshu)&& 'xuesheng'==this.flag){
